...
public class TransposicaoChave {
	...
	return chave+" select * from produto where limite >="+soma+"and esf_fim>="+esf_fim+ " and esf_ini<="+esf_ini+" and cil_fim >="+cil_fim+" and cil_ini <="+cil_ini;
			 }		
				}	 
	...
	//return chave+" select * from produto where esf_fim>="+esf_fim+ " and esf_ini<="+esf_ini+" and cil_fim >="+cil_fim+" and cil_ini <="+cil_ini;
		 ...
		 if (grau_esferico >=-6.00 && grau_esferico <=-4.25){
		   ...
		   if (grau_esferico >=-6.00 && grau_esferico <=-4.25){
				...
				soma= soma*-1;
				return chave+" select * from produto where limite >="+soma+" and esf_fim>="+esf_fim+ " and esf_ini<="+esf_ini+" and cil_fim >="+cil_fim+" and cil_ini <="+cil_ini;
				//return chave+" select * from produto where esf_fim>="+esf_fim+ " and esf_ini<="+esf_ini+" and cil_ini >="+cil_ini+" and cil_fim <="+cil_fim;
			 }
