...
<div style="float: left;">
	<p style="display: block; margin-right: 10px">EsfÃ©rico   :</p><input id="odesf" name="odesf" style="margin-right: 10px; text-align: right;" type="text" size="10" maxlength="10">
</div>
<div style="float: left;">
	<p style="display:block; margin-right: 10px">CilÃ­ndrico :</p><input id="odcil" name="odcil" style="margin-right: 10px; text-align: right;" type="text" size="10" maxlength="10" >
</div>
<div style="float: left;">
	<p style="display:block; margin-right: 15px">AdiÃ§Ã£o :</p><input style="margin-right: 10px; text-align: right;" type="text" size="10" maxlength="10">
</div>
</fieldset>
<fieldset style="margin-bottom: 10px;width: 330px; height: 72px;"><legend>Olho Esquerdo</legend>
	<div style="float: left;">
	<p style="display: block; margin-right: 10px">EsfÃ©rico   :</p><input id="oeesf" name="oeesf" style="margin-right: 10px; text-align: right;" type="text" size="10" maxlength="10">
</div>
<div style="float: left;">
	<p style="display:block; margin-right: 10px">CilÃ­ndrico :</p><input id="oecil" name="oecil" style="margin-right: 10px; text-align: right;" type="text" size="10" maxlength="10" >
</div>
<div style="float: left;">
	<p style="display:block; margin-right: 10px">AdiÃ§Ã£o :</p><input style="margin-right: 10px; text-align: right;" type="text" size="10" maxlength="10">
</div>
</fieldset>
...
<div class="checkboxes">
 ...
 <div class="material">
    <label for="acrilico"><input type="checkbox"      name="material"  value="acrilico"      id="acrilico" /> <span>AcrÃ­lico</span></label>
 ...
 <legend>Tratamento</legend>
  <div class="tratamento"> 
    ...
    <!--  <label for="fotossensivel"><input type="checkbox" name="tratamento"  value="fotossensivel" id="fotossensivel" /> <span>FotossensÃ­vel</span></label>-->
   </div>
  </fieldset>
  
  <fieldset style="width: 150px;height:135px;float:left;margin-left:0px;margin-top: 8px">
 <legend>FotossensÃ­vel</legend>
  <div class="fotossensivel"> 
    <label for="nao"><input type="checkbox"            name="fotossensivel" value="nao"           id="nao" /> <span>NÃ£o</span></label>
    ...
    <label for="generico"><input type="checkbox"       name="fotossensivel" value="fotossensivel" id="fotossensivel" /> <span>GenÃ©rico</span></label>
   </div>
  </fieldset>
  <fieldset style="width: 150px;height:135px;float:left;margin-left:8px;margin-top: 8px">
 <legend>Ã�ndice RefraÃ§Ã£o</legend>
  <div class="indice"> 
  ...
  <table id="tabela" border="1" width="773px;">
		    <thead>
		        <tr>
		            ...
		            <th>Cor</th>
		            <th>Tratamento</th>
		            <th>FotossensÃ­vel</th>
		            <th>Indice RefraÃ§Ã£o</th>
		            <th>Valor</th>
       		    </tr>
		    </thead>
		    <tbody id="tabela">
