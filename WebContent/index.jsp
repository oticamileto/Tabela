...
<script src="./JS/AjaxParametersMontaFiltro.js"></script>
...
<div style="float: left;">
	<p style="display: block; margin-right: 10px">Esférico   :</p><input id="odesf" name="odesf" style="margin-right: 10px; text-align: right;" type="text" size="10" maxlength="10" onblur="validaNumero(this.value)">
</div>
<div style="float: left;">
...
<div class="checkboxes">
 ...
 <legend>Anti-Reflexo</legend>
  <div class="tratamento"> 
    <label for="nao"><input type="checkbox"           name="tratamento"  value="Nao"  id="nao" /> <span>Não</span></label>
     <label for="Simples"><input type="checkbox"      name="tratamento"  value="Simples" id="Simples" /> <span>Simples</span></label>
    <label for="EasyClean"><input type="checkbox"     name="tratamento"  value="EasyClean"  id="EasyClean" /> <span>EasyClean</span></label>
    <label for="CrizalEasy"><input type="checkbox"    name="tratamento"  value="Crizal Easy" id="CrizalEasy" /> <span>Crizal Easy</span></label>
    <label for="CrialForte"><input type="checkbox"    name="tratamento"  value="Crizal Forte" id="CrizalForte" /> <span>Crizal Forte</span></label>
    <label for="CrizalAlize"><input type="checkbox"   name="tratamento"  value="Crizal Alize Plus" id="CrizalAlize" /> <span>Crizal Alize</span></label>
 ...
 <legend>Índice Refração</legend>
  <div class="indice"> 
   <div style="display: block; width: 50px; float:left;">
    <label for="1.49"><input type="checkbox" name="indice"  value="1.49" id="1.49" /> <span>1.49</span></label>
    <label for="1.53"><input type="checkbox" name="indice"  value="1.53" id="1.53" /> <span>1.53</span></label>
    <label for="1.56"><input type="checkbox" name="indice"  value="1.56" id="1.56" /> <span>1.56</span></label>
    <label for="1.59"><input type="checkbox" name="indice"  value="1.59" id="1.59" /> <span>1.59</span></label>
    <label for="1.61"><input type="checkbox" name="indice"  value="1.61" id="1.61" /> <span>1.61</span></label>
    </div>
    <div style="display: block; width: 50px; float: left;">
    <label for="1.67"><input type="checkbox" name="indice"  value="1.67" id="1.67" /> <span>1.67</span></label>
    <label for="1.70"><input type="checkbox" name="indice"  value="1.70" id="1.70" /> <span>1.70</span></label> 
    <label for="1.74"><input type="checkbox" name="indice"  value="1.74" id="1.74" /> <span>1.74</span></label>
    <label for="1.80"><input type="checkbox" name="indice"  value="1.80" id="1.80" /> <span>1.80</span></label>
    <label for="1.90"><input type="checkbox" name="indice"  value="1.90" id="1.90" /> <span>1.90</span></label>
    </div>
   </div>
  </fieldset>
  </div>
