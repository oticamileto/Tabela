...
<div class="grupo_1">
<div class="receita">
<form id="myAjaxRequestForm"  action="OngetParameterNames" method="get">
...
<label for="visaosimples"><input type="checkbox" name="tipo_lente" value="visaosimples" id="visaosimples" /> <span>Visao Simples</span></label>
</div>
<div style="width: 105px;float: left;margin:auto;text-align: center;">
<label for="bifocal"><input type="checkbox" name="tipo_lente" value="bifocal" id="bifocal" /> <span>Bifocal</span></label>
</div>
<div style="width: 105px;float: left;">
<label for="multifocal"><input type="checkbox" name="tipo_lente" value="multifocal" id="multifocal" /> <span>Multifocal</span></label>
</div>
</div>
</fieldset>
